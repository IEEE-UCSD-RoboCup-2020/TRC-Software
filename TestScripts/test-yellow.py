...
for i in range(0, 6):
    ...
    run_cmd_term([vfirm_cmd, vfirm_port, vfirm_robot_id, vfirm_is_yellow], vfirm_dir, False)
    time.sleep(1)
...
for i in range(0, 6):
    ...
    run_cmd_term([tritonBot_cmd, tritonBot_virtual, "-i", str(i), tritonBot_port_base, tritonBot_vfirm_port], tritonBot_dir, False)   
